<?php
    ...
    $phpmailer->AddAddress( 'c.barr4@hotmail.com', 'Circe Barrera' );// Correo del destinatario y nombre
...
<?php else : ?>
    <p class="error"> No fue posible enviar tus datos, inténtalo nuevamente. </p>
<?php endif; ?>
